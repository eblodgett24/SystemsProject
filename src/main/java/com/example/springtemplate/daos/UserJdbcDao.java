...
public class UserJdbcDao {
    ...
    static final String SCHEMA = "project";
    ...
    String UPDATE_USER = "UPDATE users SET first_name=?, last_name=?, username=?, password=?, email=?, dateOfBirth=?, profilePicture=? WHERE id=?";
